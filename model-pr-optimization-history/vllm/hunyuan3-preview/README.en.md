...
- Trace source: `git log --name-only -- <model-files>` found it through `vllm/reasoning/hy_v3_reasoning_parser.py`, `vllm/tool_parsers/hy_v3_tool_parser.py`; associated commits `cc56379e28a0`; preserved from an explicit existing history/skill citation
