...
- 反查来源: `git log --name-only -- <model-files>` 反查到 `vllm/reasoning/hy_v3_reasoning_parser.py`, `vllm/tool_parsers/hy_v3_tool_parser.py`；关联提交 `cc56379e28a0`；保留自原 history/skill 显式引用
